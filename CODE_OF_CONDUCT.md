...
Project maintainers may remove content, reject contributions, or temporarily or permanently exclude participants whose behavior is harmful. Report conduct concerns privately to the maintainers through the repository owner's GitHub profile. Reports will be reviewed confidentially and without retaliation.

This policy applies in project spaces and when representing the project elsewhere. It is adapted from the Contributor Covenant 2.1.
